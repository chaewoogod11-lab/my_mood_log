...
export default function PostCard({ nickname, title, content, imageUrl, date }: any) {
  return (
    <div className="group cursor-pointer">
      {/* 닉네임 표시: 타이틀보다 위에 아주 미니멀하게 배치 */}
      <p className="text-[10px] font-bold mb-3 text-stone-400 uppercase tracking-[0.2em] transition-colors group-hover:text-[#2C241D]">
      ...
      <div className="relative overflow-hidden aspect-[4/5] mb-6 bg-stone-200">
        ...
        {/* 날짜 배지 */}
        <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-md px-3 py-1 text-[10px] tracking-tighter font-medium uppercase text-[#2C241D]">
